...
public class MyCustomSink extends AbstractSink implements Configurable {
    ...
    private MyFileLogger MyCustomSink;
    ...
    public void configure(Context context) {
        ...
        String sinkFileName = context.getString(SINK_FILENAME, "This is a sink_file"); // /tmp/flume_rollingfile_sink/rolling_file.log
        ...
        MyCustomSink = new MyFileLogger(sinkId, sinkFileName, sinkFilePattern);
    }
