 ...
 *
 */
public class MyCustomSource extends AbstractSource implements Configurable, PollableSource {
    private static final org.slf4j.Logger logger = LoggerFactory.getLogger(MyCustomSource.class);
